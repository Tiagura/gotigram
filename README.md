...
- `/subscribe <app_id|all> [-p <priority>] [-f <Plain|Markdown|MarkdownV2|HTML>]` - Subscribe to a specific application by its ID, or to all applications using all. Optionally set a priority (0-10, defaults to 0) and/or a parse format (Markdown|MarkdownV2|HTML, defaults to Markdown).
...
- `/import` - Import subscriptions from a JSON array (does not save to file).
